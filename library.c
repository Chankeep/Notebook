...
void add(void) // 自定义函数：添加
{
    ...
    printf("书名: ");
    scanf("%49s", lib[count].title);
    lib[count].borrowed = false;
    count++;
    printf("已添加。\n");
}
void del(void) // 自定义函数：删除
{
